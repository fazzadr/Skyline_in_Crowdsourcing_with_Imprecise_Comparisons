...
for _c_sample_number in range(1, num_samples_for_each_input_configuration + 1):
    ...
    for num_points, num_dimensions in list__num_points__num_dimensions:
        ...
        #
        # SortedDims try_random_quicksort=True
        skln__lex_sort_skln = c_solver.twoSort_skln(list_of_points, c_worker,
                                                    map__num_points__best_s=map__num_points__best_s,
                                                    reset_set_comparisons=True, try_random_quicksort=True)
        ...
        # SortedDims s=1
        # all_play_all
        # all_play_all_2(self, list__point, worker, use_complete_comparisons=False, reset_set_comparisons=True):
        # all_play_all_based_on_Beat_Or_Tie_relation
        skln__lex_sort_skln = c_solver.all_play_all_based_on_Beat_Or_Tie_relation(list_of_points, c_worker,
